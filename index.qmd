...
*Easy geom recipes* is a new, researched and tested point of entry for learning *Stat* extension.  The materials are aimed at academics, data analysts, BI professionals, seasoned and new ggplot2 users, statistics educators and their students, journalists, etc.
...
[**Let's get cooking!**: *Work through Recipes 1-3: compute_group*](easy_geom_recipes_compute_group.qmd){.btn .btn-outline-primary .btn role="button" data-toggle="tooltip" title="Take me to lesson 1."}

[**Rather a taster platter?**: *Leaf through some recipes*](https://evamaerey.github.io/mytidytuesday/2022-01-03-easy-geom-recipes/easy_geom_recipes_flipbook_2024.html){.btn .btn-outline-primary .btn role="button" data-toggle="tooltip" title="Take me to lesson 1."}
