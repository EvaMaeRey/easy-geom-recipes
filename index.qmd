...
*Easy geom recipes* is a new point of entry for learning *Stat* extension.  The materials are aimed at academics, data analysts, BI professionals, seasoned and new ggplot2 users, statistics educators and their students, journalists, etc. The approach has been tested and evaluated by data science and statistics educators.
