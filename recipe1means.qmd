...
In this exercise, we'll demonstrate how to add a point at the medians x and y by defining the new extension function `geom_medians()`. Then you'll be prompted to define `geom_means()` based on what you've learned.
