...
In this exercise, we'll thinking about a way to add a point at the medians x and y, defining the new extension function `geom_medians()` which could be used as follows:
...
Here a quick review of the definitional code we've covered, dropping tests and discussion.
...
Next up:  How would you write the function geom_id() which annotates a row number for data points on a scatterplot?
