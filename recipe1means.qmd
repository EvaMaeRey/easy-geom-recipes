...
### Pro tip: use ggplot2::layer_data() to inspect the render-ready data ggplot2 prepared in the background
...
# consider alias to something even more user-facing -- users love geom_*() functions
...
## Step 3. Alternate, express approach, user-facing function. (unvetted)
