...
```{r}
extension_levels <- c("I didn't know about any extension mechanisms!",
...
```{r}
tutorial_length <- c("The tutorial length was about right", 
...
```{r}
example_levels <- c("The examples were easy to follow",
...
```{r}
example_engagement <- c("In general, I did not find the examples interesting or engaging",
...
```{r}
likelihood_levels <- c('Very likely - I already have ideas for how to use!',
                       'Somewhat likely',
...
likelihood_levels <- c('Very likely', 
                       'Somewhat likely', 
                       'Neither likely nor unlikely', 
                       'Somewhat unlikely', 
                       'Very unlikely')
