...
```{r , include=FALSE}
knitr::opts_chunk$set(echo = T, eval = T, fig.width = 8, fig.height = 5.5, out.width = "85%", warning = F, fig.path = "fig_")
```
...
```{r q21emotion}
survey$q21 <- str_remove(survey$q21, ";$")

plot_multi_responses(survey, q21, levels = q21_levels, 
                     var_title = q_long[21]) + 
  scale_y_discrete(breaks = q21_levels) + 
  scale_fill_viridis_d(option = "C", guide = "none")
...
knitr::include_graphics(c("fig_q05r_length_user-1.png",
                        "fig_q06r_frequency-1.png",
                        "fig_q07ggplot2_frequency-1.png",
                        "fig_q08r_frequency-1.png",
                        "fig_q09ggplot2_contexts-1.png",
                        "fig_q10_previous_ext_experience-1.png",
                        "fig_q11_previous_ext_attempt-1.png",
                        "fig_q13_oop_experience-1.png"))

```

```{r, out.width="33%", fig.show='hold'}
knitr::include_graphics(c(
                        "fig_q14which_completed-1.png",
                        "fig_q15number_completed-1.png",
                        "fig_q16tutorial_time_taken-1.png",
                        "fig_q17tutorial_length-1.png",
                        "fig_q18example_clarity-1.png",
                        "fig_q19examples_engaging-1.png",
                        "fig_q21emotion-1.png",
                        "fig_q22futureuse-1.png",
                        "fig_q26longtaught-1.png"))
