...
```{r , include=FALSE}
knitr::opts_chunk$set(echo = T, eval = T, fig.width = 8, fig.height = 5.5, out.width = "85%", warning = F, fig.path = "survey_results_figures/", echo = F, include = F)
```
...
```{r, out.width="99%", fig.show='hold', include=T}
...
```{r, out.width="99%", fig.show='hold', include=T}
knitr::include_graphics(c("survey_results_figures/q10_previous_ext_experience-1.png",                        "survey_results_figures/q11_previous_ext_attempt-1.png",
