...
```{r}
#| label: fitted_3
StatFitted <- ggplot2::ggproto(`_class` = "StatFitted",
...
stat_fitted <- function(mapping = NULL, data = NULL, geom = "point", position = "identity", 
    ..., show.legend = NA, inherit.aes = TRUE) {
    layer(data = data, mapping = mapping, stat = StatFitted, 
...
- Switch out `StatIdentity` with your Stat, e.g. `StatFitted`. 
